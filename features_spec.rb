...
describe 'velian Bewertungs-Suche', :js=> true do
    it "should search the google for something" do 
        ...
        find(:xpath, "/html/body/span/g-lightbox/div[2]/div[3]/span/div/div/div/div[2]/div[1]/div/div[2]/div[1]/div[1]/div[3]/div[1]/g-review-stars")
        sleep 2
        find(:xpath, "/html/body/span/g-lightbox/div[2]/div[3]/span/div/div/div/div[2]/div[1]/div/div[2]/div[1]/div[1]/div[3]/div[2]/span/span[1]/a").click
        reviewtext = page.find(:xpath, "/html/body/span/g-lightbox/div[2]/div[3]/span/div/div/div/div[2]/div[1]/div/div[2]/div[1]/div[1]/div[3]/div[2]/span/span[2]").text
        puts "reviewtext:'#{reviewtext}'"
